...
test_that("stabilize_one_of() disambiguates identical matched labels by position (#286)", {
  # The same specify_dbl() spec is passed twice; both match 1.5, so their
  # (otherwise identical) labels must be told apart by position
  expect_pkg_error_snapshot(

...
test_that("specify_lst() respects pre-configured element specs (#110, wranglezone/stbl#310)", {
...
test_that("stabilize_lst() with nested specify_lst() propagates errors correctly (#204, wranglezone/stbl#310)", {

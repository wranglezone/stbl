...
test_that("stabilize_arg() complains about weird args (#11, #58, #99)", {
...
test_that("stabilize_arg() checks NAs (#11, #58, #99)", {
  given <- 1:8
...
test_that("stabilize_arg() checks size args (#11, #58, #99)", {
  given <- TRUE
...
test_that("stabilize_arg() checks min_size (#11, #58, #99)", {
  given <- 1:3
  expect_identical(

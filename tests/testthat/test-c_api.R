...
test_that(".chr_to_int() converts integer strings (#220)", {
  expect_identical(
...
test_that(".chr_to_int() converts whole-number double strings (#220)", {
  expect_identical(
...
test_that(".chr_to_int() passes NA through (#220)", {
  expect_identical(.chr_to_int(NA_character_), NA_integer_)
})

test_that(".chr_to_int() returns NA for strings with fractional parts (#220)", {
...
test_that(".chr_to_dbl() converts numeric strings (#220)", {
  expect_identical(
...
test_that(".chr_to_dbl() converts Inf strings (#220)", {
  expect_identical(
...
test_that(".chr_to_dbl() passes NA through (#220)", {

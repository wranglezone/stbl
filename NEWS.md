...
* `stabilize_dbl()` and `stabilize_int()` now use a C implementation for min/max range checks, eliminating intermediate logical vector allocations and improving throughput for large vectors (#220).

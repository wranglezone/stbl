...
[`to_time()`](https://stbl.wrangle.zone/reference/to_time.md)/[`stabilize_time()`](https://stbl.wrangle.zone/reference/stabilize_time.md)
...
[`object_type()`](https://stbl.wrangle.zone/reference/object_type.md) is
`"time"`.

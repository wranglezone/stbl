...
Thanks for using stbl! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/wranglezone/stbl/issues/new).
...
requests](https://github.com/wranglezone/stbl/issues) to make sure the

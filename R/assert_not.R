...
#' **would** be accepted by `spec`, and returns `x` unchanged otherwise.
#'
#' @param spec A single stabilizer function, `to_*` function, `specify_*()`
#'   result, or `assert_*` function that `x` must **not** match.
